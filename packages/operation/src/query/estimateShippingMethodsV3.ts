...
export const estimateShippingMethodsV3 = gql`
  query estimateShippingMethodsV3(
    $cartId: String
    $isGuest: Boolean
      ...
      shipping_method {
        ...
        extension_attributes {
          ...
          pickup_stores_location(
            filter: {
              keyword: $pickupStoresLocationFilterKeyword,
              location: $pickupStoresLocationFilterLocation,
              input: $input
            },
